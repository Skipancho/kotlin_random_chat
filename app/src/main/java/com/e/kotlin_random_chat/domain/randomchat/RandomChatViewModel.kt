...
import com.e.kotlin_random_chat.api.RandomChatApi
...
import com.e.kotlin_random_chat.domain.randomchat.websocketclient.RandomChatWebSocketClient
...
class RandomChatViewModel(app : Application)
    ...
    private fun handleMessage(
        ...
        synchronized(messages){
            val messageModel = MessageModel(
                owner, message.senderNickName, message.message
            )
    ...
    override fun onMessageError(t: Throwable) {
        Log.e(TAG, "메시지 오류 발생.", t)
        toast("메시지 오류가 발생했습니다.")
    }
